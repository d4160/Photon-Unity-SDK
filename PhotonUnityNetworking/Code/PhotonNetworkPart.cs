    ...
    private class SerializeViewBatch : IEquatable<SerializeViewBatch>, IEquatable<RaiseEventBatch>
    {
        ...
        internal static void LoadLevelIfSynced()
        {
            ...
            if (sceneId is int)
            {
                ...
                {
                    //PhotonNetwork.LoadLevel((int)sceneId, LoadSceneMode.Additive);
                    OnSyncLevelLoad?.Invoke((int)sceneId);
                }
            }
            else if (sceneId is string)
            {
                ...
                {
                    PhotonNetwork.LoadLevel((string)sceneId, LoadSceneMode.Additive);
                }
            }
        }
